...
Durable technical facts, as distinct from decisions (why we chose something) and
plan (what is left to do). Things that are simply true and that a session would
otherwise have to rediscover.

| File | Contents |
|---|---|
| [`brief-original.md`](brief-original.md) | The original design brief, verbatim, with a note on what is now wrong |
